...
\centering 
  \begin{tikzpicture}
    \begin{axis}[font=\footnotesize,clip mode=individual,height=7cm,width=9cm,legend style={draw=none,fill=none,legend pos=south west,font=\footnotesize}]    
      ...
      \addplot[mark=*,color=blue,only marks,/pgfplots/error bars/.cd,
        x dir=none,
        y dir=both,
