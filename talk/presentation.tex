...
\frame{
\frametitle{The shortest vector problem}
Longstanding applications in computer science:
\begin{itemize}
...
\item check solvability by radicals {\tiny (Landau and Miller 1985)}
...
\begin{itemize}
\item minimum distance of lattice codes {\tiny (Conway and Sloane 1998, Erez~et.~al. 2004)}
...
\item multi-antenna communication (MIMO),
...
\item Do applications such as global positioning, phase unwrapping, etc., involve lattices of Voronoi's first kind?
