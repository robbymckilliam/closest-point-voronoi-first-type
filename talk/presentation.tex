...
\begin{itemize}
\item minimum distance of lattice codes {\tiny (Conway and Sloane 1999, Erez~et.~al. 2004)}
...
\item vector quantisation and compression {\tiny (Conway~and~Sloane~1982, Erez~et.~al.~2005)},
...
\frametitle{The closest lattice point problem}
\begin{itemize}
\item Applications require fast solutions to the closest lattice point problem.
\item NP-hard for arbitrary lattices.
\item Easier for specific lattices.
...
\item Can MIMO communications systems benefit?
